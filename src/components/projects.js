  ...
  return (
    <div className='pt-20 mb-20'>
      ...
      <div className="bg-gray-300 text-center flex-col justify-centered rounded-md shadow-xl px-4 py-4 mx-auto mt-20 xs:w-5/6">
        ...
        <h2 className="xs:text-xs sm:text-md md:text-lg lg:text-2xl font-semibold text-gray-800 ml-4 mt-4 text-center">And many more...</h2>
    ...
    return (
      <div class="max-w-xl mx-auto">
          <div class="flex flex-col justify-center items-center">
              <a class='relative shadow-lg rounded-md hover:filter transition' href={project.link} target="_blank" rel="noreferrer">
              <img
