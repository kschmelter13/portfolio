...
export default function Contact() {
  return (
    <div className='pt-20 mb-20'>
      <h2 className="xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 text-center">Contact</h2>
        ...
        <div className="bg-white rounded-md shadow xs:px-0 px-6 py-14 mx-auto">
            <section className="text-gray-700 body-font relative">
                ...
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    If you like the work I've done or just want to chat, lets start talking! 
                    </p>
                </div>
                <div className="lg:w-3/4 md:w-3/4 mx-auto">
                    <form action="https://formspree.io/f/mjvdrbjr" target='_blank' method="POST">
                        <div className="flex xms:flex-col sm:flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                <button type='submit' className="submit-button py-3 px-8 rounded-full">
                                Send message
                                </button>
                            </div>
                        </div>    
                    ...
                    <div className="p-2 w-full pt-8 mt-4 border-t border-gray-200 text-center">
                        ...
                        <a target='_blank' href='https://www.linkedin.com/in/kevin-schmelter-3b84291b5/' className="text-gray-500">
                            <svg
                            fill="currentColor"
