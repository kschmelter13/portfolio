...
export const projectData = [
  {
    ...
    image: portfolio,
    description:
      "Paradox! My portfolio website I built from scratch using React and Tailwind, and hosted on Render.com also using Formspree. Full source on Github.",
  ...
  },
  {
    ...
    image: pods,
    description:
      'A bank account budgeter that allows users to separate their money in "Pods". Uses React and Bootstrap for the frontend, and Supabase for the backend.',
  ...
  },
  {
    ...
    image: returns,
    description:
      "A web app I built for Rug Pad USA that loads, parses, and tracks amazon xml returns using the UPS API. Built with React, Bootstrap, Supabase and secured with OAuth Azure.",
  ...
  },
  {
    ...
    image: binarytree,
    description:
      "A project built for my data structures and algorithms class written in C++. Has a menu for executing operations on a binary tree that stores course information.",
